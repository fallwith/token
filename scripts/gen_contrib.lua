...
local function gen_bat(p, variant, _term)
  ...
  local scopes = {
    ...
    tmtheme_entry('String', 'string, punctuation.definition.string', p.orange, nil),
    ...
    tmtheme_entry('Number', 'constant.numeric', p.olive, nil),
    ...
    tmtheme_entry('Heading 5', 'heading.5.markdown', p.orange, 'bold'),
