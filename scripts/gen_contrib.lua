...
local function gen_zsh(p, variant, _term)
  ...
  local lines = {
    ...
    "ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#" .. s(p.red) .. "'",
    "ZSH_HIGHLIGHT_STYLES[reserved-word]='fg=#" .. s(p.accent2) .. "'",
    "ZSH_HIGHLIGHT_STYLES[alias]='fg=#" .. s(p.blue) .. "'",
    "ZSH_HIGHLIGHT_STYLES[suffix-alias]='fg=#" .. s(p.blue) .. "'",
    "ZSH_HIGHLIGHT_STYLES[global-alias]='fg=#" .. s(p.blue) .. "'",
    "ZSH_HIGHLIGHT_STYLES[builtin]='fg=#" .. s(p.blue) .. "'",
    "ZSH_HIGHLIGHT_STYLES[function]='fg=#" .. s(p.accent) .. "'",
    "ZSH_HIGHLIGHT_STYLES[command]='fg=#" .. s(p.blue) .. "'",
    "ZSH_HIGHLIGHT_STYLES[precommand]='fg=#" .. s(p.accent2) .. "'",
    "ZSH_HIGHLIGHT_STYLES[commandseparator]='fg=#" .. s(p.fg2) .. "'",
    "ZSH_HIGHLIGHT_STYLES[hashed-command]='fg=#" .. s(p.blue) .. "'",
    "ZSH_HIGHLIGHT_STYLES[autodirectory]='fg=#" .. s(p.fg1) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[path]='fg=#" .. s(p.fg1) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#" .. s(p.fg2) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#" .. s(p.fg1) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[globbing]='fg=#" .. s(p.purple) .. "'",
    "ZSH_HIGHLIGHT_STYLES[history-expansion]='fg=#" .. s(p.purple) .. "'",
    "ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter]='fg=#" .. s(p.fg2) .. "'",
    "ZSH_HIGHLIGHT_STYLES[process-substitution-delimiter]='fg=#" .. s(p.fg2) .. "'",
    "ZSH_HIGHLIGHT_STYLES[back-quoted-argument-delimiter]='fg=#" .. s(p.fg2) .. "'",
    "ZSH_HIGHLIGHT_STYLES[single-quoted-argument]='fg=#" .. s(p.green) .. "'",
    "ZSH_HIGHLIGHT_STYLES[double-quoted-argument]='fg=#" .. s(p.green) .. "'",
    "ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=#" .. s(p.green) .. "'",
    "ZSH_HIGHLIGHT_STYLES[single-quoted-argument-unclosed]='fg=#" .. s(p.red) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[double-quoted-argument-unclosed]='fg=#" .. s(p.red) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument-unclosed]='fg=#" .. s(p.red) .. ",underline'",
    "ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]='fg=#" .. s(p.purple) .. "'",
    "ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]='fg=#" .. s(p.purple) .. "'",
    "ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]='fg=#" .. s(p.purple) .. "'",
    "ZSH_HIGHLIGHT_STYLES[assign]='fg=#" .. s(p.fg0) .. "'",
    "ZSH_HIGHLIGHT_STYLES[redirection]='fg=#" .. s(p.purple) .. "'",
    "ZSH_HIGHLIGHT_STYLES[comment]='fg=#" .. s(p.fg2) .. ",italic'",
    "ZSH_HIGHLIGHT_STYLES[single-hyphen-option]='fg=#" .. s(p.fg1) .. "'",
    "ZSH_HIGHLIGHT_STYLES[double-hyphen-option]='fg=#" .. s(p.fg1) .. "'",
    "ZSH_HIGHLIGHT_STYLES[named-fd]='fg=#" .. s(p.orange) .. "'",
    "ZSH_HIGHLIGHT_STYLES[numeric-fd]='fg=#" .. s(p.orange) .. "'",
    "ZSH_HIGHLIGHT_STYLES[arg0]='fg=#" .. s(p.blue) .. "'",
    '',
    '# Completion',
